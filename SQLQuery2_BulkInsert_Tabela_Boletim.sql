...
BULK INSERT BancoDadosFmu20212n.grp01.BOLETIM
-- Define-se o caminho e nome do arquivo fonte.
FROM 'C:\Users\User\OneDrive\Área de Trabalho\FMU\3° Semestre\BANCO DE DADOS\Scripts Homologados - SQL Server (Suporte a aula SQL- DML)\BOLETIM.csv'
WITH
(
 FORMAT = 'CSV',
 DATAFILETYPE	='char',
 ...
 ERRORFILE='C:\Users\User\OneDrive\Área de Trabalho\FMU\3° Semestre\BANCO DE DADOS\Scripts Homologados - SQL Server (Suporte a aula SQL- DML)\boletimERROS.txt'
);