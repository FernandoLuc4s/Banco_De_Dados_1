...
FROM 'C:\Users\User\OneDrive\Área de Trabalho\FMU\3° Semestre\BANCO DE DADOS\Scripts Homologados - SQL Server (Suporte a aula SQL- DML)\GRADE.csv'
WITH
(
 FORMAT = 'CSV',
 DATAFILETYPE	='char',
 ...
 ERRORFILE='C:\Users\User\OneDrive\Área de Trabalho\FMU\3° Semestre\BANCO DE DADOS\Scripts Homologados - SQL Server (Suporte a aula SQL- DML)\gradeERROS.txt'
);